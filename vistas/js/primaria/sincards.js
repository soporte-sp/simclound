...
$(document).on("click", ".agregarSimcardMultiple", function(){
   ...
   var capturarcoordinador = $('#capturarUsuarioCordinador35').val();
  ...
  $(".nuevoCampoSimcard2").append(
          ...
          '<div class="col-sm-12" style="padding:5px 8px;">'+
            ...
            '<input type="hidden" placeholder="Nombre del operador" class="form-control" name="addcordinadorinv[]" value="'+capturarcoordinador+'">'+
