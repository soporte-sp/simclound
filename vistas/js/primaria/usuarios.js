...
$("#formInsert").validate({
  ...
  submitHandler: (form) => {
      ...
      OBJECT_DATA = {
          ...
          idcoordinadordeadmin: $('#addcordinadoradmin').val() == null ? '' : $('#addcordinadoradmin').val(),
      };
      DATA.append("DATA", JSON.stringify(OBJECT_DATA));
      app.callAjax('controladores/usuario.controlador.php', DATA, (response) =>{
          if(response.RESULT){
  ...
  app.callAjax('controladores/usuario.controlador.php', DATA, (response) => {
    ...
    $("#editarNombre").val(response.nombre);
      ...
      if(response.perfil == "Agencias"){
        ...
        $('#idCordinadorActual').val(response.idcoordinadordeadmin);
...
$("#formEditar").validate({
  ...
  submitHandler: (form) => {
      ...
      OBJECT_DATA = {
        ...
        idCordinadorActual: $('#idCordinadorActual').val(),
