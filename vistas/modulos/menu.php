        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        <img alt="image" width="50px" class="img-circle" src="vistas/img/avatar.jpg" />
                    </span>
            ...
            <li>
                <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">Ventas</span><span
                        class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                <?php
                    if ($_SESSION["perfil"] == "Administrador" || $_SESSION["perfil"] == "Coordinador") {
                        echo '<li><a href="ventas">Ver Ventas</a></li>';
                    } else {
                        echo '<li><a href="ventas">Ver Ventas</a></li>';
                        echo '<li><a href="crear-venta">Nueva Venta</a></li>';
                    }
                ?>
            ...
            if ($_SESSION["perfil"] == "Administrador") {
                echo
                    ' <li>
                                    <a href="planes"><i class="fa fa-plane"></i> <span class="nav-label">Planes</span></a>
                            </li>';
            }
            ?>
