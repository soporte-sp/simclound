...
if($_SESSION["perfil"] == "Administrador"){
  ...
  $ventasHoy = ControladorVentas::ctrSumaTotalVentasHoy($item,$valor,$perfil);
  $ventasMes = ControladorVentas::ctrSumaTotalVentasMes($item,$valor,$perfil);
  $ventas = ControladorVentas::ctrMostrarVentas($item, $valor,$item1,$valor3,$perfil);
  ...
  $ventasHoy = ControladorVentas::ctrSumaTotalVentasHoy($item,$valor,$perfil);
  $ventasMes = ControladorVentas::ctrSumaTotalVentasMes($item,$valor,$perfil);
  $ventas = ControladorVentas::ctrMostrarVentas($itemcontar, $valorcontar,$item1,$valor3, $perfil);
  $totalVentas = count($ventas);
