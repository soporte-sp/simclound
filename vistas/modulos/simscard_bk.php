                    ...
                    <table class="table table-bordered table-striped dt-responsive TablasSimcards">
                        ...
                        <tbody>
                            ...
                            if ($_SESSION["perfil"] == "Administrador") {
                                ...
                                $select1 = "agrego";
                                $select2 = "addcoodininve";
                                $valor2 = $_SESSION["idcoordinadordeadmin"];

                                $simscard = ControladorSimscard::ctrMostrarSimscardAgencias($item, $valor, $select, $valor1, $select1, $valor2, $select2);
                            ...
                            <td>';
                                if ($usuarios["usuario2"])
                                    echo $usuarios["usuario2"];
                                echo '</td><td>';

                                if (is_array($usuarios) && $usuarios["perfil"] == "Comercial") {
                                    echo $usuarios["perfil"] . ' (' . $usuarios["comercial"] . ')';
                                } else if (is_array($usuarios) && $usuarios["perfil"]) {
                        ...
                        <div class="col-sm-10">
                            <select class="form-control m-b chosen-select inputFormu2" onchange="validar2()" name="nuevoUsuario2[]" id="capturarUsuario2" data-placeholder="Escoge el cliente" tabindex="2">
                                ...
                                if ($_SESSION["perfil"] == "Administrador") {
                                    ...
                                    $valor = $_SESSION["id"];
                                    $perfil = "id";
                                    $valor1 = $_SESSION["idcoordinadordeadmin"];
                                    $perfil1 = "idcoordinadordeadmin";
