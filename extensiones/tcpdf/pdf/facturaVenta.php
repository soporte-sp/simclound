...
<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:150px; text-align:center"><img src="../../../$imei"></td>
...
$bloque6 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:150px; text-align:center"><img src="../../../$simcard"></td>
		<td style="border: 1px solid #666; background-color:white; width:150px; text-align:center">$valor</td>
