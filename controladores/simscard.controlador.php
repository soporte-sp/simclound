...
class ControladorSimscard
{
		...
		if (isset($_POST["selector"])) {
			...
			if ($respuesta == "ok") {
				...
				echo '<script>
							...
							swal({
							    title: "¿Está seguro de borrar las simcards?",
							    ...
							    confirmButtonColor: "#3085d6",
							      ...
							      confirmButtonText: "Si, borrar simcards!"
							  }).then(function(result){
							    ...
							    if(result.value){
							   	...
							   	swal({
										  type: "success",
										  title: "Las simcards han sido borradas correctamente",
										  showConfirmButton: true,
										  confirmButtonText: "Cerrar"
	...
	static public function ctrMostrarSimscardAgencias($item, $valor, $select, $valor1, $select1, $valor2, $select2)
	{

		$tabla = "simcards";

		$respuesta = ModeloSimscards::mdlMostrarSinscardAgencias($tabla, $item, $valor, $select, $valor1, $select1, $valor2, $select2);
